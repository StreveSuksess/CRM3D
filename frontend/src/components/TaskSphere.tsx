	...
	return (
		<>
			<TextMesh text={addLineBreaks(props.task)}
								...
								scale={0.0003} />
			<Sphere
				position={props.tasksLength > 9 ? spherePositions[props.index] : new Vector3(props.projectPosition.x + positions[props.tasksLength][props.index][0], props.projectPosition.y + positions[props.tasksLength][props.index][1], props.projectPosition.z + positions[props.tasksLength][props.index][2])}
